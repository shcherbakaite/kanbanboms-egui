**Local fork** of [egui-data-table](https://github.com/kang-sw/egui-data-table) v0.4.0 for use in kanbanboms. Modifications: POS/ID (row index) column is removed so the table shows only data columns.
